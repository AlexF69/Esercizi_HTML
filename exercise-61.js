// # Async Management - Exercise 5 --> 61
// Implementare le funzioni `fetchPersonById` e `fetchJobById`, le quali dato un id devono restituire
// rispettivamente:
...
// N.B: esiste un metodo che, dato in input un array di `Promise`, attende fino a quando
// una delle `Promise` non viene risolta o rigettata.
...
// uso metodo promise.race per eseguire le promise e ritornare valore della prima eseguita
Promise.race([fetchPersonById(1), fetchJobById(2)]).then((value) => {
  console.log(value);
});
